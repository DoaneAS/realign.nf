...
//
params.input         = null
params.output_dir    = "results_uBam"
...
params.bwa_index    =    '/gpfs/commons/groups/imielinski_lab/DB/references/Homo_sapiens/GATK/GRCh38/Sequence/BWAIndex/Homo_sapiens_assembly38.fasta'
//
...
//
    ...
    process umap {
        ...
        clusterOptions "-l h_rss=180G -R y -l h_rt=120:00:00 -cwd"
        ...
        file_tag_new = file_tag+'.umap'

        '''
        umap.sh !{bamfile} !{file_tag_new} 
